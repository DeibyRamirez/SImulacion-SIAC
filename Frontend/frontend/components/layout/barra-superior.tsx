    ...
    <>
      <header className="panel-topbar flex h-[4.5rem] items-center gap-4 px-4 md:px-6">
        ...
        <button
          ...
          className="mx-auto flex h-10 w-full max-w-md items-center gap-2 rounded-full border border-primary/15 bg-white px-4 text-sm text-muted-foreground shadow-sm transition-all hover:border-cyan-tecnico/40 hover:shadow-md"
        >
          <Search className="size-4 shrink-0 text-cyan-tecnico" />
          <span className="flex-1 text-left">Buscar en todo SIAC…</span>
      ...
      <BusquedaGlobal abierta={busquedaAbierta} onCambiarAbierta={setBusquedaAbierta} />
    </>
  )
}
